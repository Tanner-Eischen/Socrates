...
class CollaborationService {
     ...
     */
    static async createCollaborationSession(data) {
        try {
      ...
      `;
            ...
            logger_1.logger.error('Error creating collaboration session', { error, data });
            throw error;
        }
    }
    /**
    ...
    static async joinSession(data) {
        try {
            ...
            const isAuthorized = collaboration.studentId === data.userId ||
            ...
            logger_1.logger.info('User joined collaboration session', {
                collaborationSessionId: data.collaborationSessionId,
                userId: data.userId,
                role: data.role,
            ...
            logger_1.logger.error('Error joining collaboration session', { error, data });
            throw error;
        }
    }
    /**
     ...
     */
    static async leaveSession(collaborationSessionId, userId) {
        try {
            ...
            logger_1.logger.info('User left collaboration session', {
                collaborationSessionId,
                userId,
                roomId: collaboration.roomId,
            });
            ...
            logger_1.logger.error('Error leaving collaboration session', { error, collaborationSessionId, userId });
            throw error;
        }
    }
    /**
    ...
    static async sendMessage(data) {
        try {
            ...
            logger_1.logger.error('Error sending message', { error, data });
            throw error;
        }
    }
    /**
    ...
    static async findById(id) {
        try {
            ...
            logger_1.logger.error('Error finding collaboration session by ID', { error, id });
            throw error;
        }
    }
    /**
    ...
    static async findByUserId(userId, limit = 20, offset = 0) {
      ...
      `;
            ...
            logger_1.logger.error('Error finding collaboration sessions by user ID', { error, userId });
            throw error;
        }
    }
    /**
    ...
    static async updateStatus(id, status) {
      ...
      `;
            ...
            const collaboration = result.rows[0];
            logger_1.logger.info('Collaboration session status updated', { id, status });
            return {
                id: collaboration.id,
                sessionId: collaboration.session_id,
                tutorId: collaboration.tutor_id,
            ...
            logger_1.logger.error('Error updating collaboration session status', { error, id, status });
            throw error;
        }
    }
    /**
     ...
     */
    static getActiveParticipants(roomId) {
     ...
     */
    static getUserCurrentSession(userId) {
        return this.userSessions.get(userId) || null;
    }
    /**
     * Check if user is in a session
     */
    static isUserInSession(userId) {
        return this.userSessions.has(userId);
    }
    /**
     * Get room participants count
     */
    static getRoomParticipantCount(roomId) {
    ...
    static async getActiveSessions() {
      ...
      `;
            ...
            logger_1.logger.error('Error getting active collaboration sessions', { error });
            throw error;
        }
    }
    /**
    ...
    static async getCollaborationStats(userId) {
      ...
      `;
            ...
            logger_1.logger.error('Error getting collaboration stats', { error, userId });
            throw error;
        }
    }
    /**
    ...
    static async scheduleSession(data) {
        try {
            ...
            logger_1.logger.info('Collaboration session scheduled', {
            ...
            logger_1.logger.error('Error scheduling collaboration session', { error, data });
            throw error;
        }
    }
    /**
    ...
    static async cancelSession(id, reason) {
        try {
            ...
            logger_1.logger.info('Collaboration session cancelled', { id, reason });
        }
        catch (error) {
            logger_1.logger.error('Error cancelling collaboration session', { error, id });
            throw error;
        }
    }
}
exports.CollaborationService = CollaborationService;
CollaborationService.db = DatabaseService_1.DatabaseService;
CollaborationService.activeSessions = new Map(); // roomId -> Set of userIds
CollaborationService.userSessions = new Map(); // userId -> roomId
